...
public class singletonProduseServiceFile implements produseService {
    ...
    private static ro.arthursplaytime.gui.produse.singletonProduseServiceFile singletonProduseServiceFile = new singletonProduseServiceFile();
    public static ro.arthursplaytime.gui.produse.singletonProduseServiceFile getInstance(){
    ...
    public void modificarePret(int id, double pret) {
        try{
            ...
            if(produsOptional.isPresent()){
                ...
                produseService produseService = ro.arthursplaytime.gui.produse.singletonProduseServiceFile.getInstance();
